...
const presetAvatars = [
  ...
  PresetAvatar(
    ...
    label: 'Mentari',
    category: PresetAvatarCategory.general,
  ),
  PresetAvatar(
    id: 'leaf',
  ...
  PresetAvatar(
    ...
    label: 'Andre',
    category: PresetAvatarCategory.people,
    gender: PresetAvatarGender.male,
  ),
  PresetAvatar(
    id: 'person_pink',
    ...
    label: 'Chelsie',
    category: PresetAvatarCategory.people,
    gender: PresetAvatarGender.female,
  ),
  PresetAvatar(
    id: 'person_green',
      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: selected
                ? avatar.color.withValues(alpha: .13)
                : colors.surfaceContainerHigh,
            borderRadius: BorderRadius.circular(15),
            border: Border.all(
              color: selected
                  ? avatar.color
                  : colors.outlineVariant.withValues(alpha: .35),
              width: selected ? 2 : 1,
            ),
          ),
          child: Column(
